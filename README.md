...
| Version | Innehåll |
|---------|----------|
| 3.5.2 | Diagram: y-axeln skalas nu smart efter de aktiva värdenas min/max i stället för att alltid utgå från 0 — gäller Trender (`LineChartCanvas`) och Idag-diagrammen energi/steg/vilopuls (delad `SparklineChart`). Ett smalt värdeband fyller nu diagramhöjden i stället för att klämmas ihop i toppen (#136) |
