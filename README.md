...
| Version | Innehåll |
|---|---|
| 3.7.2 | Fix: Hantera-sidopanelens sektionsikoner var inte scrollbara på de flesta telefoner — de nedersta ikonerna gick inte att nå (HANT-5). Fix: Trender-ytan saknade helt diagram för Steg och Vilopuls (Health Connect) — visas nu som egna periodväljbara diagram (TRD-10). Fix: "+"-FAB på Idag saknade ett sätt att logga en fristående screening — nytt snabbval "Logga screening" (HEM-8b) (#146) |
