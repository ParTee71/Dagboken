...
class HistorikScreenTest {
    ...
    @Test fun empty_state_shown_when_no_entries() = retryOnRenderGlitch {
        setUp()
        try {
            setContent()
    ...
    @Test fun entries_from_all_sources_are_displayed() = retryOnRenderGlitch {
        setUp()
        try {
            runBlocking {
                aktivRepo.save(
    ...
    @Test fun long_press_opens_delete_menu_and_confirm_removes_the_entry() = retryOnRenderGlitch {
        setUp()
        try {
            runBlocking {
                aktivRepo.save(
    ...
    @Test fun toggling_a_filter_chip_hides_that_type() = retryOnRenderGlitch {
        setUp()
        try {
            runBlocking {
                aktivRepo.save(
    ...
    @Test fun switching_to_calendar_view_hides_the_list_and_shows_the_calendar_empty_state() = retryOnRenderGlitch {
        setUp()
        try {
            runBlocking {
                aktivRepo.save(
    ...
    @Test fun switching_back_to_list_view_restores_the_list() = retryOnRenderGlitch {
        setUp()
        try {
            runBlocking {
                aktivRepo.save(
